...
using AutoMapper;
using My.Project.Entity.Attributes;
using My.Project.Utility.Extensions;
...
namespace My.Project.Core.Extensions
{
    public static partial class ServiceExtensions
    {
        ...
        public static IServiceCollection AddAutoMapper(this IServiceCollection services, Action<IMapperConfigurationExpression> configure = null)
        {
            ...
            maps.AddRange(GlobalMetaData.AllTypes.Where(x => x.GetCustomAttribute<MapAttribute>() != null)
            ...
            var configuration = new MapperConfiguration(cfg =>
            {
                ...
                cfg.AddMaps(GlobalMetaData.AllFxAssemblies);
