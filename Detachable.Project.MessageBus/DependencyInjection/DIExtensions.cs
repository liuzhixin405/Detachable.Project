...
using Detachable.Project.Hosting;
using Detachable.Project.Options;
...
namespace Detachable.Project.DependencyInjection
{
    /// <summary>
    /// HostBuilder 扩展
    /// </summary>
    public static class DIExtensions
    {
        public static IHostBuilder UseMessageBus(this IHostBuilder hostBuilder,Func<IEnumerable<IProducer>> addProducer=null,Func<IEnumerable<IConsumer>> addConsumer=null)
        {
            hostBuilder.ConfigureServices((host, services) =>
            {
                ...
                services.AddSingleton<Detachable.Project.Abstractions.IMessageBus>(svp => new Detachable.Project.Abstractions.MessageBus());
            });
            return hostBuilder;
        }
